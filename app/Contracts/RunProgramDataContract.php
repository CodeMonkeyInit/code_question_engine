...
class RunProgramDataContract extends BaseContract implements JsonSerializable
{
    ...
    public function fillFromJson($json)
    {
      ...
      $paramSets = json_decode($json['paramSets']);

      foreach($paramSets as $paramSetJson){
          $paramSet = new ParamsSet();
          $paramSet->fillFromJson($paramSetJson);
          $this->paramSets[] = $paramSet;
      }
      unset($json['paramSets']);

        parent::fillFromJson($json);
    }
